...
function createCash() {
  if (World.frameCount % 200 == 0) {
   //Modificar las posiciones del dinero 
    var cash = createSprite(Math.round(random(75, 2500),50, 30, 30));
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(Math.round(random(75, 2500),50, 30, 30));
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(Math.round(random(75, 2500),50, 30, 30));
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(Math.round(random(75, 2500),50, 30, 30));
